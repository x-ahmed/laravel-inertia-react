(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Users_Edit_js"],{
...
var Edit = function Edit(_ref) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    setForm(function (form) {
      return _objectSpread(_objectSpread({}, form), user);
    });
  }, []);
  ...
  var submit = function submit(e) {
    e.preventDefault();
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_2__.Inertia.patch("/users/".concat(user.id), form);
  };
